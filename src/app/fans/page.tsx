...
export const metadata = { title: 'Fans — Myrtle365' };
...
export default async function FansPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold tracking-tight">Fans</h1>
      <p className="mt-1 text-slate-600">The people who show up, follow, and tip.</p>
